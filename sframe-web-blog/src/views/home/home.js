...
import blogContent from "./content/blog-content.vue";
...
export default {
  ...
  data() {
    return {
      ...
      result:[
        {
          "url": "https://api.github.com/gists/a7b556ccddcf94902b15659f34cae73f",
          "forks_url": "https://api.github.com/gists/a7b556ccddcf94902b15659f34cae73f/forks",
          "commits_url": "https://api.github.com/gists/a7b556ccddcf94902b15659f34cae73f/commits",
          "id": "a7b556ccddcf94902b15659f34cae73f",
          "node_id": "MDQ6R2lzdGE3YjU1NmNjZGRjZjk0OTAyYjE1NjU5ZjM0Y2FlNzNm",
          "git_pull_url": "https://gist.github.com/a7b556ccddcf94902b15659f34cae73f.git",
          "git_push_url": "https://gist.github.com/a7b556ccddcf94902b15659f34cae73f.git",
          "html_url": "https://gist.github.com/a7b556ccddcf94902b15659f34cae73f",
          "files": {
            "2018.5.22 更新": {
              "filename": "2018.5.22 更新",
              "type": "text/plain",
              "language": null,
              "raw_url": "https://gist.githubusercontent.com/GitHub-Laziji/a7b556ccddcf94902b15659f34cae73f/raw/b90e52f3850751d4e1c6227f5fbfa0e6d14bf414/2018.5.22%20%E6%9B%B4%E6%96%B0",
              "size": 35821
            }
          },
          "public": true,
          "created_at": "2018-05-22T04:19:03Z",
          "updated_at": "2018-05-22T04:19:03Z",
          "description": "1 增加其他站点的配置, 在状态栏显示个人的其他网站\n2 优化部分提示效果\n3 修复博客描述没有换行\n4 修改点击其他博客异常的bug\n5 修改日期格式\n6 修改使用帮助显示效果",
          "comments": 0,
          "user": null,
          "comments_url": "https://api.github.com/gists/a7b556ccddcf94902b15659f34cae73f/comments",
          "owner": {
            "login": "GitHub-Laziji",
            "id": 30425217,
  ...
  methods: {
    getMenuList() {
      for (let i = 0; i < this.result.length; i++) {
        for (let key in this.result[i].files) {
          let data = {}
          data['title'] = key

package com.sframe.common.dao.impl;

import com.sframe.common.dao.IRepository;
...
public class RepositoryDao<T, ID extends Serializable> extends
	...
	public Page pagedQuery(final String ql, final QueryMap qm,
		...
		if (qm.getValueMap() != null) {
			query = createQuery(
					com.sframe.common.dao.support.Query.queryAccession(hql, qm),
					values);
			...
			query = createQuery(
					com.sframe.common.dao.support.Query.queryAccession(hql,
